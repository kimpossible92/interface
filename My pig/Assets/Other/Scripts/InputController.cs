...
public class InputController : MonoBehaviour {
   ...
   void Start () {
	...
	void LateUpdate () {
        ...
        {
            whatCubeClicked = Camera.main.ScreenPointToRay(Input.mousePosition);
            RaycastHit initTest = new RaycastHit();bool cubeWasClicked = false;
            if(Physics.Raycast(whatCubeClicked, out initTest))
            {
                cubeWasClicked = initTest.transform.gameObject.GetComponent<Cubelet>().inPlay;
            }
